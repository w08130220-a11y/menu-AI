...
const THEMES = {
  slate: {
    ...
    cardBorder: "#e2e8f0",
    sideBg: "#0f172a",
    sideText: "rgba(226,232,240,0.65)",
    sideTextActive: "#ffffff",
    sideActiveBg: "rgba(59,130,246,0.22)",
    sideLabel: "rgba(226,232,240,0.32)",
    brandAccent: "#60a5fa",
    primary: "#2563eb",
    barMain: "#2563eb",
    barSoft: "#dbeafe",
    good: "#16a34a",
    chipBg: "#fef3c7",
    statusWork: { bg: "#dcfce7", fg: "#15803d" },
    statusOff: { bg: "#f1f5f9", fg: "#94a3b8" },
  },
  graphite: {
    name: "石墨琥珀（暖中性）",
    pageBg: "#fafaf9",
    ...
    cardBorder: "#e7e5e4",
    sideBg: "#1c1917",
    sideText: "rgba(231,229,228,0.62)",
    sideTextActive: "#fbbf24",
    sideActiveBg: "rgba(251,191,36,0.13)",
    sideLabel: "rgba(231,229,228,0.30)",
    brandAccent: "#fbbf24",
    primary: "#292524",
    barMain: "#44403c",
    barSoft: "#e7e5e4",
